...
if (!function_exists('understrap_widgets_init')) {
	...
	function understrap_widgets_init()
	{
		...
		register_sidebar(
			array(
				'name'          => __('Woocommerce Before Shop Load Hook Widget area', 'understrap'),
				'id'            => 'wc_before_shop_load_widget_area',
				'description'   => __('Full sized footer widget with dynamic grid', 'understrap'),
				'before_widget' => '<div id="%1$s" class="wc_before_shop_load_widget_area %2$s dynamic-classes">',
				'after_widget'  => '</div>',
				'before_sidebar' => '<span class="anastasia">',
