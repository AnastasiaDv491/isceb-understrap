...
/* Code should be moved to seperate plugin for events */
...
/* TODO: #14 Better logic needed e.g. what if event is multiple days*/
...
<div class="isceb-event-card">
	...
	<div class="isceb-event-message-box">
		<?php if ($isceb_event_countdown->invert == 0) : ?>
			<?php if ($isceb_event_countdown->d < 1) : ?>
				<h6>Event is today</h6>
